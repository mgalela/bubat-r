...
- scope_topics: `[comma-separated topics covered by this directory]`
- dir_path: `[relative path from federation root, e.g. . or ./backend]`
- federation_root: `[relative path to root node, e.g. ./ or ../../]`
...
| ------------------------------------------------------------ | ----------- | ------------- |
| _(none — run `bubat-r link <target-dir>` to register links)_ |             |               |
